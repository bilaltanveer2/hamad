...
export default function AdminCoupons() {
    ...
    const [newCoupon, setNewCoupon] = useState({
        ...
        forMember: false,
        isPublic: false,
        // store as ISO-like string suitable for datetime-local input
    ...
    const fetchCoupons = async () => {
        try {
            ...
            const { data }
                = await axios.get('/api/admin/coupon', {
                    headers: {
    ...
    const handleAddCoupon = async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                // convert from local datetime string to Date on the server
    ...
    return (
        <div className="text-slate-500 mb-40">
            ...
            <form onSubmit={(e) => toast.promise(handleAddCoupon(e), { loading: "Adding coupon..." })} className="max-w-sm text-sm">
                ...
                <label>
                    <p className="mt-3">Coupon Expiry Date &amp; Time</p>
                    <input
                        type="datetime-local"
                            ...
                            {coupons.map((coupon) => (
                                <tr key={coupon.code} className="hover:bg-slate-50">
                                    ...
                                    <td className="py-3 px-4 text-slate-800">
                                        {format(new Date(coupon.expiresAt), 'yyyy-MM-dd HH:mm')}
                                    </td>
